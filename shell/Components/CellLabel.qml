...
Text {
    ...
    // wingpanel's band) carries the weight that holds it together over
    // whatever is under it. The shadow is the cell's, drawn behind the whole
    // content box by Components/InkGlow.qml.
