...
// `mutedForeground`, sentence case (2026-09-18 theme boundary: text casing
// is global, not a theme's). `count` renders as a trailing ` (3)` when it
// is zero or more; a negative count draws nothing.
//
