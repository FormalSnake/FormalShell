...
// "keyboardLayout", "systemUpdate", "chevron", "airpods", "dualsense" and
// "display" are deliberately absent from DEFAULT_LAYOUT below: all eleven are
// opt-in builtins (M12 Task 8, M14 Task 7, M16 Task 8, the ASCII visualizer's
// own owner-ask task, the cheap-wins trio, M24's collapse boundary, M29 Tasks
// 3+4's AirPods/DualSense cells, and M36's display cell — the display panel
// long predates having a cell at all, so opting it in is a deliberate choice
// rather than a default every existing install would suddenly render), so
// the no-config bar stays byte-identical.
var BUILTIN_WIDGETS = ["workspaces", "activeWindow", "clock", "nowPlaying", "battery", "audio", "network", "bluetooth", "weather", "tray", "github", "usage", "tailscale", "visualizer", "bell", "indicators", "microphone", "keyboardLayout", "systemUpdate", "chevron", "airpods", "dualsense", "display"];
