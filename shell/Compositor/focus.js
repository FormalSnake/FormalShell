...
//
// The compositor drops its focused window the moment one of the shell's own
// layer surfaces takes keyboard focus, so opening any FormalShell panel
...
// surface took focus (the shell has no cross-surface focus registry, and the
// compositor reports none). A remembered window that has closed, or
